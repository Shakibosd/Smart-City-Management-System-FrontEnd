async function fetchTransportData() {
    try {
        const response = await fetch(
            "https://smart-city-management.onrender.com/public_transport/transport/"
        );
        if (!response.ok) {
...
async function openEditModal(transportId) {
    try {
        const response = await fetch(`https://smart-city-management.onrender.com/public_transport/transport/${transportId}/`);
        if (!response.ok) {
