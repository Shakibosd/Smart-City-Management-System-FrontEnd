...
function fetchEmergencyServices() {
  fetch("https://smart-city-management.onrender.com/public_safety/safety/", {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
    },
...
function fetchTrafficStatus() {
  fetch("https://smart-city-management.onrender.com/traffic_management/traffic_status/", {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
    },
...
function fetchIncidentReports() {
  fetch("https://smart-city-management.onrender.com/reporting_system/reports/", {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
    },
